...
- Minor: Will change with minimal loss of functionality, increasing a constraint or removing Deprecated properties.
...
- Drop Indexes _if specified_
- Run Migration Pipelines _if provided_
- Create Indexes _if specified_
- Apply Schema
- Load Test Data _if requested_
